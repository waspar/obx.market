...
SELECT I.ID AS ID, B.ORDER_ID AS ORDER_ID, I.BASKET_ID AS BASKET_ID, I.PRODUCT_ID AS PRODUCT_ID, I.PRODUCT_NAME AS PRODUCT_NAME, I.QUANTITY AS QUANTITY, I.WEIGHT AS WEIGHT, I.PRICE_ID AS PRICE_ID, I.PRICE_VALUE AS PRICE_VALUE, I.DISCOUNT_VALUE AS DISCOUNT_VALUE, I.TOTAL_PRICE_VALUE AS TOTAL_PRICE_VALUE FROM obx_basket_items AS I LEFT JOIN obx_basket AS B ON (B.ID = I.BASKET_ID) WHERE (1=1) AND ( I.BASKET_ID = '57' OR I.BASKET_ID = '58' OR I.BASKET_ID = '59' OR I.BASKET_ID = '60' OR I.BASKET_ID = '61' ) AND ( I.BASKET_ID <> '57' AND I.BASKET_ID <> '58' AND I.BASKET_ID <> '59' AND I.BASKET_ID <> '60' AND I.BASKET_ID <> '61' ) AND (B.ORDER_ID IS NULL) AND ( B.ORDER_ID IS NOT NULL AND B.ORDER_ID <> '1' AND B.ORDER_ID <> '' AND B.ORDER_ID <> '2' ) AND ((1<>1) OR (I.PRICE_VALUE > '10.32') OR (I.PRICE_VALUE < '1000.46') ) AND ((1<>1) OR (I.DISCOUNT_VALUE < '0.10') OR (I.DISCOUNT_VALUE >= '0.00') ) AND ((1<>1) OR (I.VAT_ID IS NOT NULL) OR (I.VAT_VALUE < '30.46') ) AND ((1<>1) OR (I.VAT_ID IS NOT NULL) OR (I.VAT_VALUE < '30.46') ) AND ((1<>1) OR (I.VAT_ID = '') OR (I.PRICE_VALUE = '100') ) ORDER BY I.ID ASC
SQL
			, $lastQueryString);
