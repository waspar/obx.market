...
OBX_CopyDirFilesEx($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/obx.market/install/php_interface/event.d/obx.market.mysql_group_concat_max_len.php", $_SERVER["DOCUMENT_ROOT"]."/bitrix/php_interface/event.d/", true, true);
